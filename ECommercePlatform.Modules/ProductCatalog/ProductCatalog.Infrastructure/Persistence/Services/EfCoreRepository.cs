...
public class EfCoreRepository<TAggregate>(ProductCatalogDbContext dbContext)
    : IRepository<TAggregate> where TAggregate : class
{
    protected ProductCatalogDbContext Context { get; } = dbContext;

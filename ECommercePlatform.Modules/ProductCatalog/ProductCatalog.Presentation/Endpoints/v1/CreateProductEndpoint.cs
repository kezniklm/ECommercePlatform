...
public static class CreateProductEndpoint
{
    ...
    [EndpointDescription("Creates a new product with the specified name and image URL")]
    [ProducesResponseType(typeof(CreateProductResponse), StatusCodes.Status201Created)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public static async Task<IResult> CreateV1(CreateProductRequest request, IMessageBus bus)
    {
        ...
        {
            { IsSuccess: true } => Results.Created($"/products/{result.Value.ProductId}",
